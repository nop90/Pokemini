...
// mods by nop90 for 3d platform marked with 3DS remark 
...
//	pixellayout &= 15;											// 3DS
	...
	if (pixellayout == PokeMini_RGB32) {						// 3DS
		UI_Font1_Pal32 = (uint32_t *)PokeMini_Font12_PalRGB32;	// 3DS
		UI_Font2_Pal32 = (uint32_t *)PokeMini_TFont12_PalRGB32;	// 3DS
		UI_Icons_Pal32 = (uint32_t *)PokeMini_Icons12_PalRGB32;	// 3DS
	} else if  (pixellayout == PokeMini_RGB15) {				// 3DS
...
//	int iii;
//	for (iii=0;iii <512*512;iii++) screen[iii] = 0b000000000011111; // test
}
